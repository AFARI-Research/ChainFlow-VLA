...
try:
    ...
    # Newer transformers versions removed QWEN2_ATTENTION_CLASSES and related class wiring.
    # Keep import-time compatibility so non-packed training paths can still run.
    QWEN2_ATTENTION_CLASSES = None
    Qwen2FlashAttention2 = object
...
def replace_qwen2_attention_class():
    if QWEN2_ATTENTION_CLASSES is None:
        print('Skip replacing QWEN2_ATTENTION_CLASSES: current transformers version is not supported by this packed-training patch.')
        return
