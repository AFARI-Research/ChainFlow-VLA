...
try:
    ...
    # Newer transformers versions (e.g. 4.57+) removed LLAMA_ATTENTION_CLASSES.
...
def replace_llama_attention_class():
    if LLAMA_ATTENTION_CLASSES is None:
        print('Skip replacing LLAMA_ATTENTION_CLASSES: current transformers version is not supported by this packed-training patch.')
        return
